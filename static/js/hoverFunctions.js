...
// all replaced in html w/ bootstrap hover tooltip
...
// // hover over monthly chart
// const chartMonthButton = document.getElementById("month_chart");

// chartMonthButton.addEventListener('mouseover', () => {
//     document.getElementById('pop_month_chart').style.display = 'block';
// });

// chartMonthButton.addEventListener('mouseout', () => {
//     document.getElementById('pop_month_chart').style.display = 'none';
// });
